...
namespace Opsive.ThirdPersonController.Editor
{
    ...
    public class CharacterBuilder : EditorWindow
    {
        ...
        [SerializeField] private ModelType m_ModelType;
        [SerializeField] private GameObject m_Character;
        [SerializeField] private bool m_AIAgent;
#if !(UNITY_4_6 || UNITY_4_7 || UNITY_5_0)
        [SerializeField] private bool m_IsNetworked;
#endif
        [SerializeField] private bool m_AddStandardAbilities = true;
        [SerializeField] private bool m_AddRagdoll = true;
        [SerializeField] private bool m_IsHumanoid;
        [SerializeField] private RigidbodyCharacterController.MovementType m_MovementType = RigidbodyCharacterController.MovementType.Combat;
        ...
        public static void ShowWindow()
        {
            ...
            window.minSize = new Vector2(520, 355);
        }
